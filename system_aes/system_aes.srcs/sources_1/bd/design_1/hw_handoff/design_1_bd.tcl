...
proc create_root_design { parentCell } {
  ...
  set AES_IP_TOP_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:AES_IP_TOP:2.0 AES_IP_TOP_0 ]
  ...
  connect_bd_net -net rst_ps7_0_20M_interconnect_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins rst_ps7_0_20M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_20M_peripheral_aresetn [get_bd_pins AES_IP_TOP_0/M_AXI_ARESETN] [get_bd_pins AES_IP_TOP_0/s_apb_paresetn] [get_bd_pins axi_apb_bridge_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins rst_ps7_0_20M/peripheral_aresetn]
